...
public class SapStrength extends SpellRay {
    ...
    public SapStrength() {
        super(WizardryNextGeneration.MODID, "sap_strength", SpellActions.POINT, false);
        this.aimAssist(0.6F);
        ...
        if (EntityUtils.isLiving(target)) {
            ...
            if (MagicDamage.isEntityImmune(MagicDamage.DamageType.SHOCK, target)) {
                ...
                if (target instanceof EntityLivingBase) {
                    ...
                    targetEntity.addPotionEffect(new PotionEffect(MobEffects.WEAKNESS, (int)(WNGSpells.sap_strength.getProperty(EFFECT_DURATION).floatValue() * modifiers.get(WizardryItems.duration_upgrade)),(int)((modifiers.get(SpellModifiers.POTENCY) -1) * 3.5), false, false));
                }
            }
            return true;
        } else {
