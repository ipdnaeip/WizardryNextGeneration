...
public class LayerWebspitterEyes<T extends EntityWebspitter> implements LayerRenderer<T> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(WizardryNextGeneration.MODID, "textures/entity/webspitter_eyes.png");

    private final RenderWebspitter mainRenderer;

    public LayerWebspitterEyes(RenderWebspitter renderer){
