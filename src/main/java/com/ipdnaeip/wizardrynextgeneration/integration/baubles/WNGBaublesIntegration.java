package com.ipdnaeip.wizardrynextgeneration.integration.baubles;
 ...
 *
 * @author Electroblob, WinDanesz, modified for use by ipdnaeip
 */
public final class WNGBaublesIntegration {
    ...
    public static void init() {
        ...
        ARTEFACT_TYPE_MAP.put(ItemNewArtefact.AdditionalType.BODY, BaubleType.BODY);
    ...
    // Shamelessly copied from WinDanesz who copied it from The Twilight Forest, with a few modifications
