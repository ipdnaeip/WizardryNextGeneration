...
public class EntityAIAnimalFollowPlayer extends EntityAIBase {
    ...
    public EntityAIAnimalFollowPlayer(EntityAnimal summonedCreature, double followSpeedIn, float minDistIn, float maxDistIn, EntityPlayer playerToFollow) {
    ...
    public boolean shouldExecute() {
        EntityLivingBase ownerCaster = playerToFollow;
